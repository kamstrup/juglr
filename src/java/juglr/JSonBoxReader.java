 ...
 * reuse the same JSonBoxReader by calling {@link #reset(Box)} when starting
 * the serialization of a new message.
 * <p/>
 * Note that contrary to {@link JSonBoxReader} this class is not thread
 * safe.
 *
 * @see Box
 * @see BoxReader
